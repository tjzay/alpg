...
#input files:
weather_irradiation = 'input/weather/our_solar_data.csv' #input our solar data
...
location = LocationInfo(name='Melbourne', region='Australia', timezone='Australia/Melbourne', latitude=-37.8, longitude=144.95)
...
PVAngleMean = 			20 		#degrees, 0 is horizontal to earth surface
PVAngleSigma = 			10		#degrees
PVAzimuthMean = 		0 	    #degrees, 0 is north, 90 is east
PVAzimuthSigma = 		10 		#degrees
